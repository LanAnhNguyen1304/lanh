                                ...
                                <table id="datatablesSimple">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center; ">Nội dung liên hệ</th>
                                    ...
                                    ;?>
                                        <tr>
                                            ...
                                            <td style="text-align: center; "><?php echo $row["ten_nguoi_lien_he"];?></td>
                                            <td style="text-align: center; "><?php echo $row["email_nguoi_lien_he"];?></td>
                                            <td style="text-align: center; "><?php echo $row["sdt_nguoi_lien_he"];?></td>
                                            <td style="text-align: center; "><?php echo $row["noi_dung_lien_he"];?></td>

                                            <td style="text-align: center; "><a href="lien_he_sua.php?id=<?php echo $row['lien_he_id'];?>">Sửa</a></td>
                                            <td style="text-align: center; "><a href="lien_he_xoa.php?id=<?php echo $row['lien_he_id'];?>">Xóa</a></td>
