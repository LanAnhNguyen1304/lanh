                            ...
                            <div class="card-body">
                                <form method="POST" action="tin_tuc_them_moi_thuc_hien.php" enctype="multipart/form-data">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtTieuDe" name="txtTieuDe" placeholder="Tiêu đề bài viết" />
                                            <label for="txtTieuDe">Tiêu đề bài viết</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtTheLoai" name="txtTheLoai" placeholder="Thể loại bài viết" />
                                            <label for="txtTheLoai">Thể loại bài viết</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtMoTa" name="txtMoTa" placeholder="Mô tả bài viết" />
                                            <label for="txtMoTa">Mô tả bài viết</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtNoiDung" name="txtNoiDung" placeholder="Nội dung bài viết" />
                                            <label for="txtNoiDung">Nội dung bài viết</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtTacGia" name="txtTacGia" placeholder="Tác giả bài viết" />
                                            <label for="txtTacGia">Tác giả bài viết</label>
                                    </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3">
                                            <input type="file" class="form-control" id="txtAnhMinhHoa" name="txtAnhMinhHoa" placeholder="Chọn ảnh minh họa" />
                                                <label for="txtAnhMinhHoa">Ảnh minh họa</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="txtNgayDangTin" name="txtNgayDangTin" placeholder="Chọn ngày đăng tin" />
