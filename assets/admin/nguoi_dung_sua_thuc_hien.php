...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        $sql= "UPDATE `tbl_nguoi_dung` SET `ten_nguoi_dung` = '".$ten_nguoi_dung."',`email`='".$email."',`mat_khau`='".$mat_khau."' WHERE `tbl_nguoi_dung`.`nguoi_dung_id` = '".$nguoi_dung_id."'
            ";
